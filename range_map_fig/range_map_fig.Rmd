...
```{r}
range_shp <- st_read(here_file("Projects", "PA_paper", "range_map_fig", "ebird", "amwo_combined_2021_4326.shp")) %>%
...
Load a basemap
```{r}
basemap_ras <- raster::stack(here_file("Data", "basemaps", "esri_lightgrey", "esri_lightgrey_36_48_4326.tif"))
```
