...
# federal data only #
#full variables
#predictor_list <- c(lsm_500m_ai, lsm_500m_cohesion, lsm_500m_ed, lsm_500m_pland, lsm_500m_agri, lsm_500m_dev, lsm_1km_ai, lsm_1km_cohesion, lsm_1km_ed, lsm_1km_pland, lsm_1km_agri, lsm_1km_dev, lsm_5km_ai, lsm_5km_cohesion, lsm_5km_ed, lsm_5km_pland, lsm_5km_agri, lsm_5km_dev, lsm_10km_ai, lsm_10km_cohesion, lsm_10km_ed, lsm_10km_pland, lsm_10km_agri, lsm_10km_dev, forest_30m, elev_30m, slope_30m, soil_drainage_30m, twi_30m, ecoregions, sclass)

#threshold variables
#predictor_list <- c(elev_30m, lsm_10km_dev, lsm_5km_cohesion, lsm_5km_agri, lsm_5km_ed, lsm_5km_ai, lsm_10km_agri, ecoregions, lsm_5km_dev, lsm_5km_pland, lsm_10km_cohesion, lsm_10km_ai, lsm_10km_ed, lsm_500m_agri, lsm_1km_ai, lsm_1km_agri, lsm_500m_ai, lsm_10km_pland, lsm_500m_pland, lsm_1km_cohesion, lsm_1km_ed, lsm_1km_pland, lsm_500m_cohesion, lsm_500m_ed, lsm_500m_dev, slope_30m, twi_30m, soil_drainage_30m, lsm_1km_dev, sclass)

#interpretation variables
#predictor_list <- c(elev_30m, lsm_10km_dev, lsm_5km_cohesion, lsm_5km_agri, lsm_5km_ed, lsm_5km_ai, lsm_10km_agri, ecoregions, lsm_5km_dev)

#prediction variables
#predictor_list <- c(elev_30m, lsm_10km_dev, lsm_5km_cohesion, lsm_5km_agri, lsm_5km_ed, lsm_10km_agri, ecoregions, lsm_5km_dev)
...
#stackSave(predictor_stack, "predictor_stack_interpretation_residential.stk")
#predictor_stack <- stackOpen("predictor_stack_interpretation_residential.stk")
...
```{r}
#rf_map <- predict(rf, data = predictor_stack, type = "cloglog")
...
# federal data only #
# old
# "pland_200m_1k_30m_5070 + ai_200m_1k_30m_5070 + cohesion_200m_1k_30m_5070 + ed_200m_1k_30m_5070 + pland_1k_5k_30m_5070 + ai_1k_5k_30m_5070 + cohesion_1k_5k_30m_5070 + ed_1k_5k_30m_5070 + factor(layer.1) + DEM_PA_30m + DEM_PA_30slope + layer.2 + DEM_PA_30m_twi"
# full x
#"lsm_ai_30m_500m_5070 + lsm_cohesion_30m_500m_5070 + lsm_ed_30m_500m_5070 + lsm_pland_30m_500m_5070 + lsm_agri_30m_500m_5070 + lsm_dev_30m_500m_5070 + lsm_ai_90m_1km_5070 + lsm_cohesion_90m_1km_5070 + lsm_ed_90m_1km_5070 + lsm_pland_90m_1km_5070 + lsm_agri_90m_1km_5070 + lsm_dev_90m_1km_5070 + lsm_ai_90m_5km_5070 + lsm_cohesion_90m_5km_5070 + lsm_ed_90m_5km_5070 + lsm_pland_90m_5km_5070 + lsm_agri_90m_5km_5070 + lsm_dev_90m_5km_5070 + lsm_ai_90m_10km_5070 + lsm_cohesion_90m_10km_5070 + lsm_ed_90m_10km_5070 + lsm_pland_90m_10km_5070 + lsm_agri_90m_10km_5070 + lsm_dev_90m_10km_5070 + layer.1 + DEM_PA_30m + DEM_PA_30slope + layer.2 + DEM_PA_30m_twi + level_iii_ecoregions_pa + us_200sclass_pa"

# threshold x
#"lsm_ai_30m_500m_5070 + lsm_cohesion_30m_500m_5070 + lsm_ed_30m_500m_5070 + lsm_pland_30m_500m_5070 + lsm_agri_30m_500m_5070 + lsm_dev_30m_500m_5070 + lsm_ai_90m_1km_5070 + lsm_cohesion_90m_1km_5070 + lsm_ed_90m_1km_5070 + lsm_pland_90m_1km_5070 + lsm_agri_90m_1km_5070 + lsm_dev_90m_1km_5070 + lsm_ai_90m_5km_5070 + lsm_cohesion_90m_5km_5070 + lsm_ed_90m_5km_5070 + lsm_pland_90m_5km_5070 + lsm_agri_90m_5km_5070 + lsm_dev_90m_5km_5070 + lsm_ai_90m_10km_5070 + lsm_cohesion_90m_10km_5070 + lsm_ed_90m_10km_5070 + lsm_pland_90m_10km_5070 + lsm_agri_90m_10km_5070 + lsm_dev_90m_10km_5070 + DEM_PA_30m + DEM_PA_30slope + layer + DEM_PA_30m_twi + level_iii_ecoregions_pa + us_200sclass_pa"

# interpretation x
# "DEM_PA_30m + lsm_dev_90m_10km_5070 + lsm_cohesion_90m_5km_5070 + lsm_agri_90m_5km_5070 + lsm_ed_90m_5km_5070 + lsm_ai_90m_5km_5070 + lsm_agri_90m_10km_5070 + level_iii_ecoregions_pa + lsm_dev_90m_5km_5070"

# prediction x
# "DEM_PA_30m + lsm_dev_90m_10km_5070 + lsm_cohesion_90m_5km_5070 + lsm_agri_90m_5km_5070 + lsm_ed_90m_5km_5070 + lsm_agri_90m_10km_5070 + level_iii_ecoregions_pa + lsm_dev_90m_5km_5070"
#test models
...
# 0.6147176
#interpretation
# 0.7370665 # When juiced to 2000 trees (from 500) reached 0.7266775 AUC. Not worth it in the future
#prediction
# 0.7360167
...
writeRaster(predictor_stack, "predictor_stack_adv.grd", format = "raster", bylayer = FALSE)

```

```{r}
predictor_stack <- stack("predictor_stack_adv.grd")
...
for(i in 1:nrow(fishnet)){
  ...
  crop(x = predictor_stack, y = temp_extent, 
       filename = paste0("predictor_stack_adv/predictor_stack_adv_smol_",i,".grd")) 
}
```
...
for (i in 1:305){ #0:59 There are technically 980 layers, but 971:980 are empty
  ...
  predictor_spdf <- as(raster::stack(paste0("predictor_stack_adv/predictor_stack_adv_smol_", i, ".grd")), 'SpatialPixelsDataFrame')
