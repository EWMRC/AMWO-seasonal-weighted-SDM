...
#   raster::stack(layers = c("lsm_500m_cohesion", "lsm_500m_pland", "lsm_1km_cohesion", "lsm_1km_pland", "lsm_5km_cohesion", "lsm_5km_pland"))
# 
# predictor_stack_prediction <- predictor_stack_full %>%
#   raster::stack(layers = c("lsm_500m_pland"))
# 
...
auc(rf_interpretation, test = TRUE) #0.7834553
```
...
```{r}
rf_jacknifed <- doJk(rf_biased, metric = "auc")
rf_jacknifed
```
