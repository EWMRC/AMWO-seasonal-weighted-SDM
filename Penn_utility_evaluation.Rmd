...
point_values_longer %>%
  ...
  scale_fill_gradientn(colours=r, limits = c(1,65), trans = "log", labels = round) +
  labs(fill = "Count")

ggsave(filename = "pland_5km.jpg", height = 4, width = 7)
```
...
point_values_longer %>%
  ...
  scale_fill_gradientn(colours=r, limits = c(1,65), trans = "log", labels = round) +
  labs(fill="Count")
ggsave(filename = "ai_10km.jpg", height = 4, width = 7)
```
...
ggsave(filename = "agri_10km.jpg", height = 4, width = 7)
```
...
ggsave(filename = "dev_10km.jpg", height = 4, width = 7)
```
...
ggsave(filename = "pa_comparative_ecoregion_cbfriendly.jpg", width = 8, height = 7, dpi = 320)
```
