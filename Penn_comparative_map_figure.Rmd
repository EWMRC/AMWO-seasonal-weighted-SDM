...
iterated_leaflet %>%
  mapview::mapshot(file = "m10r0_nolegend_highres.png", vwidth = 575, vheight = 375, remove_controls = NULL, zoom = 6)
...
iterated_leaflet %>%
  mapview::mapshot(file = "m0r10_nolegend_highres.png", vwidth = 575, vheight = 375, remove_controls = NULL, zoom = 6)
...
iterated_leaflet %>%
  mapview::mapshot(file = "legendonly_highres.png", vwidth =700, vheight = 375, remove_controls = NULL, zoom = 1)
```
