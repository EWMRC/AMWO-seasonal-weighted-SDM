...
pa_ecoregions <- st_read(here("methods", "Penn_migration_model", "additional_covariates", "level_iii_ecoregions_pa.shp"))
...
register_google(key = "AIzaSyBj92-KOz5sosbleU_IJWpI1lTktOh4wVU")
...
ggdraw() +
   draw_plot(ecoregion_map_plot, x = 0, y = 0.5, width = 1, height = .5) +
   draw_plot(ecoregion_bw_plot, x = 0, y = 0, width = 1, height = .5)

ggsave(filename = "pa_comparative_ecoregion.tif", width = 8, height = 7, dpi = 600, device = "tiff",
       type = "cairo", bg = "white")
```
