...
predictor_stack_iter <- brick('/home/lberigan/SDM_mig/predictor_stack_3/predictor_stack_3_30m_36.grd')
...
calc(pred_stack, fun = mean, filename = '/home/lberigan/SDM_mig/predict_output/predict_36.tif')
