...
auc(model, test = TRUE) #0.8560644
#tss(model, test = TRUE) #0.6246121 #TSS not useful for presence-only
```
...
```
Keeping: 
• Continuous: "lsm_1km_dev", "lsm_10km_ed",
...
env_hp <- subset(env_hp, c("lsm_1km_dev", "lsm_10km_ed",
"lsm_10km_agri", "lsm_10km_dev", "elev_30m",
...
env_vi <- subset(env_vi, c("lsm_1km_dev", "lsm_10km_ed",
"lsm_10km_agri", "lsm_10km_dev", "elev_30m",
"slope_30m", "soil_drainage_30m", "twi_30m", "forest_30m"))
...
results_vi
auc(results_vi, test = TRUE) #0.8313113
...
env_hp2 <- subset(env_vi, c("lsm_1km_dev", "lsm_10km_ed",
"lsm_10km_agri", "lsm_10km_dev", "elev_30m",
"slope_30m", "soil_drainage_30m", "twi_30m", "forest_30m"))
...
tuned_hypers_2@models[[1]] %>% auc(test = TRUE) #0.8399441
```
