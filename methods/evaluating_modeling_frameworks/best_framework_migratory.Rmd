...
auc(rf_full, test = TRUE) #0.8587086
...
tss(rf_full, test = TRUE) #0.6246121
```
...
auc(maxnet_full, test = TRUE) #0.6168971
#The TSS scores are measured from 1 to + 1, with 1 signifying perfect agreement and 0.60 to 0.90 suggesting good to excellent model performance (Allouche et al.
...
auc(brt_unbiased, test = TRUE) #0.6156835
#The TSS scores are measured from 1 to + 1, with 1 signifying perfect agreement and 0.60 to 0.90 suggesting good to excellent model performance (Allouche et al.
tss(brt_unbiased, test = TRUE) #0.2475193
```
