...
env <- subset(env, c("lsm_10km_agri", "lsm_10km_dev", "elev_30m", "slope_30m", "soil_drainage_30m", "ecoregions", "sclass")) 
...
auc(model, test = TRUE) #0.7995098 new 0.6738269
tss(model, test = TRUE) #0.5730518 new 0.431825
