...
## why is this in here? commenting it out for now
...
```
Keeping: 
• Continuous: "lsm_1km_dev", "lsm_10km_ed", "lsm_10km_agri", "lsm_10km_dev", "elev_30m", "slope_30m", "soil_drainage_30m", "twi_30m",
• Categorical: "forest_30m", "ecoregions", "sclass"
...
swd_vi <- prepareSWD(species = "Scolopax minor", 
           ...
           p = rename(as.data.frame(used@coords), x = coords.x1, y = coords.x2), 
           a = as.data.frame(avail@coords),
           categorical = c("forest_30m", "ecoregions", "sclass")) #, "ecoregions", "sclass"
...
results_vi
auc(results_vi, test = TRUE) #0.8041017 0.6744574
tss(results_vi, test = TRUE) #0.5792609 0.3986928
```
Final variables:
• Continuous: "lsm_10km_agri", "lsm_10km_dev", "elev_30m", "slope_30m", "soil_drainage_30m",
• Categorical: "ecoregions", "sclass"
