...
```{r}
prediction_migration <- raster(here("methods", "Penn_migration_model", "output_layer", "rf_mig_5_15_24.tif")) %>% aggregate(9)

# prediction_migration <- raster(here_file("Projects", "Penn_migration_model", "rf_unbiased_6_16_21.tif")) %>% aggregate(9)

prediction_residential <- raster(here("methods", "Penn_residential_model", "output_layer", "rf_res_5_15_24.tif")) %>% 
  aggregate(9) %>%
