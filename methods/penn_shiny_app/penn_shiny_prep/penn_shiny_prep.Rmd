...
```{r}
prediction_migration <- raster(here("methods", "Penn_migration_model", "output_layer", "rf_mig_3_13_26.tif")) %>% aggregate(9)

# prediction_migration <- raster(here_file("Projects", "Penn_migration_model", "rf_unbiased_6_16_21.tif")) %>% aggregate(9)

prediction_residential <- raster(here("methods", "Penn_residential_model", "output_layer", "rf_res_3_13_26.tif")) %>% 
  aggregate(9) %>%
...
pa_state <- st_read(here("methods", "penn_shiny_app", "penn_shiny_prep", "pennsylvania_5070.shp")) %>%
...
weight_and_write <- function(weighted_raster, new_name){
  ...
  writeRaster(temp_ras, filename = here("methods", "penn_shiny_app", "penn_shiny_prep", new_name), datatype = "INT1U", overwrite = TRUE)
}
...
```{r}
m10r0 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m10r0.tif"))
m9r1 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m9r1.tif")) 
m8r2 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m8r2.tif")) 
m7r3 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m7r3.tif")) 
m6r4 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m6r4.tif"))
m5r5 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m5r5.tif")) 
m4r6 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m4r6.tif")) 
m3r7 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m3r7.tif"))
m2r8 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m2r8.tif")) 
m1r9 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m1r9.tif"))
m0r10 <- raster(here("methods", "penn_shiny_app", "penn_shiny_prep", "m0r10.tif"))
```

Calculating gameland statistics and appending them as attributes
```{r}
gamelands <- st_read(here("methods", "penn_shiny_app", "penn_shiny_prep", "PA_gameland", "PGC_StateGameland2020.shp")) %>%
...
gamelands %>%
  st_transform(4326) %>%
  saveRDS(here("methods", "penn_shiny_app", "woodcock_weighted_habitat", "gamelands.rds"))

gamelands %>%
  st_transform(4326) %>%
  saveRDS(here("methods", "penn_shiny_app", "prerender_PA_app", "gamelands.rds"))

gamelands %>%
  st_transform(4326) %>%
  st_write(here("methods", "penn_shiny_app", "penn_shiny_prep", "gamelands_w_stats.shp"), append=FALSE)

writeRaster(m10r0, here("methods", "penn_shiny_app", "prerender_PA_app", "m10r0.tif"), overwrite=TRUE)
writeRaster(m9r1, here("methods", "penn_shiny_app", "prerender_PA_app", "m9r1.tif"), overwrite=TRUE)
writeRaster(m8r2, here("methods", "penn_shiny_app", "prerender_PA_app", "m8r2.tif"), overwrite=TRUE)
writeRaster(m7r3, here("methods", "penn_shiny_app", "prerender_PA_app", "m7r3.tif"), overwrite=TRUE)
writeRaster(m6r4, here("methods", "penn_shiny_app", "prerender_PA_app", "m6r4.tif"), overwrite=TRUE)
writeRaster(m5r5, here("methods", "penn_shiny_app", "prerender_PA_app", "m5r5.tif"), overwrite=TRUE)
writeRaster(m4r6, here("methods", "penn_shiny_app", "prerender_PA_app", "m4r6.tif"), overwrite=TRUE)
writeRaster(m3r7, here("methods", "penn_shiny_app", "prerender_PA_app", "m3r7.tif"), overwrite=TRUE)
writeRaster(m2r8, here("methods", "penn_shiny_app", "prerender_PA_app", "m2r8.tif"), overwrite=TRUE)
writeRaster(m1r9, here("methods", "penn_shiny_app", "prerender_PA_app", "m1r9.tif"), overwrite=TRUE)
writeRaster(m0r10, here("methods", "penn_shiny_app", "prerender_PA_app", "m0r10.tif"), overwrite=TRUE)
```
